"""Bridge module to convert segment JSON to Premiere cut format.

This module provides utilities to convert silence detection segments to the
format expected by Adobe Premiere ExtendScript files.
"""
...
class SegmentsData(TypedDict):
    """Structure of a segments.json cut plan."""
...
def segments_to_premiere_cuts(segments_path: str | Path) -> list[CutSegment]:
    """Convert segment data to Premiere cut format.
