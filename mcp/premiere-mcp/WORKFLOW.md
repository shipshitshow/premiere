# Premiere MCP Video Editing Workflow

## Quick Start Checklist

1. **Start proxy server**: `cd ../adobe-mcp/proxy-server && node proxy.js`
...
| Problem | Solution |
|---------|----------|
| `Could not connect to premiere command proxy server` | Start proxy: `cd ../adobe-mcp/proxy-server && node proxy.js` |
